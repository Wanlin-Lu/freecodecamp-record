...
```
* Bootstrap标题：`<h3 class="text-primary text-center">jQuery Playground</h3>`
* 相应式容器：`<div class="container-fluid">.....</div>`
* bootstrap行：`<div class="row">...</div>`
* 行中分列：`<div class="row"><div class="col-xs-6"></div><div class="col-xs-6"></div></div>`
* bootstrap的well：`<div class="col-xs-6"><div class="well">...</div></div>`
* 在well中添加button：`<div class="well"><button></button></div>`
* 默认btn样式：`<button class="btn btn-default"></button>`
* 添加jQuery选择器：`<button class="btn btn-default target"></button>`
* 添加id选择器：`<div class="well" id="right-well"></div>`
* 注释：`<!-- Only change code above this line -->`
